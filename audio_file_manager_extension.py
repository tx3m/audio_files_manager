"""
Extension to AudioFileManager with legacy compatibility methods.
...
def extend_audio_file_manager(cls):
    """
    Decorator to extend the AudioFileManager class with legacy compatibility methods.
    """
