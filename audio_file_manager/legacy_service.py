...
class LegacyServiceAdapter:
    ...
    def __init__(self, audio_manager, message_path=None, sound_level_updater=None, nextion_interface=None):
        ...
        self.message_path = message_path or audio_manager.storage_dir
    ...
    def _generate_new_file_name(self) -> None:
        ...
        if self.message_type == "away_message":
            self.audio_manager.occupied_away_messages.add(new_id)
            ...
            self.audio_manager.occupied_custom_messages.add(new_id)
            if self.nextion_interface:
        ...
        self.current_file = {
            ...
            "sampling_rate": self.audio_manager.sample_rate,
            "encoding": self.audio_manager.audio_format
        }
